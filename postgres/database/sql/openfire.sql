...
-- LDAP entries
INSERT INTO ofproperty (name, propvalue, encrypted)
VALUES
   ('xmpp.socket.ssl.active',	'true',	0),
   ('ldap.baseDN',	:'ldap_baseDN',	0),
   ('ldap.port',	'389',	0),
   ('ldap.groupNameField',	'cn',		0),
   ('ldap.groupDescriptionField',	'description',	0),
   ('ldap.posixMode',	'false',	0),
   ('ldap.autoFollowAliasReferrals',	'true',	0),
   ('ldap.connectionPoolEnabled',	'true',	0),
   ('ldap.ldapDebugEnabled',	'false',	0),
   ('ldap.usernameField',	'uid',	0),
   ...
   ('provider.vcard.className',	'org.jivesoftware.openfire.ldap.LdapVCardProvider',	0),
   ('ldap.nameField',	'cn',	0),
   ('ldap.emailField',	'mail',	0),
   ('ldap.sslEnabled',	'false',	0),
   ('ldap.override.avatar',	'false',	0),
   ('xmpp.domain',	:'xmpp_domain',	0),
   ('xmpp.auth.anonymous',	'false',	0),
   ('provider.auth.className',	'org.jivesoftware.openfire.ldap.LdapAuthProvider',	0),
   ('ldap.autoFollowReferrals',	'false',	0),
   ('ldap.host',	'ldap',	0),
   ('ldap.debugEnabled',	'false',	0),
   ('ldap.encloseDNs',	'true',		0),
   ('provider.user.className',	'org.jivesoftware.openfire.ldap.LdapUserProvider',	0),
   ('admin.authorizedJIDs',	:'admin_authorized_jid',	0),
   ('provider.group.className',	'org.jivesoftware.openfire.ldap.LdapGroupProvider',	0),
   ('ldap.startTlsEnabled',	'false',	0),
   ('ldap.groupMemberField',	'member',		0);

-- Entry for 
INSERT INTO ofpubsubaffiliation (serviceid, nodeid, jid,affiliation) 
VALUES 
('pubsub', '',:'xmpp_domain', 'owner');
